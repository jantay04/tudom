		...
		<>
			<main className='isolate'>
				...
				<div className='wrapper my-8 flex flex-col gap-8 md:gap-12'>
					...
					<ul
						role='list'
						className='mx-auto mt-10 grid  grid-cols-1 gap-x-6 gap-y-20 sm:grid-cols-2 lg:max-w-4xl lg:gap-x-8 xl:max-w-none'
					>
						{people.map(person => (
				...
				{/* Logo cloud */}
				<div className='min-h-[60vh] relative isolate -z-10 mt-32 sm:mt-48'>
